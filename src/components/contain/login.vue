  ...
  <div class="main">
    <el-form :model="ruleForm" :rules="rules2" ref="ruleForm" label-position="left" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="account">
        <el-input type="text" v-model="ruleForm.account" auto-complete="off" placeholder="手机号/邮箱" v-on:keyup.enter="handleSubmit2"></el-input>
      </el-form-item>
      ...
      handleSubmit2(ev) {
        ...
        self.$refs.ruleForm.validate((valid) => {
          if (valid) {
            ...
            axios.get(window.g.url+'/cms/login',{params:{user_id:self.ruleForm.account,ticket:self.password,auth_time:self.timestamp}}).then(res=>{
              if(res.data.code==='40001'){
                ...
                sessionStorage.setItem("content",JSON.stringify(d))
