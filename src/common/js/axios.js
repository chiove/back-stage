...
export default {
  ...
  /*每日数据页面*/
    ...
    getSchoolList:function (userId) {
      this.axiosGet('/select-data/secondary-college/query-by-user',{
        userId:userId
      })
    },
  ...
  getDailyExeceptionTotal:function (data) {
    /*{date}必填yyyy-MM-dd*/
    /*{orgId}机构ID可选*/
    this.axiosGet('/analysis/exeception-stat-by-day',data)
  },
  ...
  getDailyExeceptionPagenation:function (data) {
    ...
    this.axiosGet('/analysis/exeception-clock-by-day',data)
  },
    /*4、下拉数据查询接口-专业信息 GET /select-data/major-info/all  可以根据院系来查，或者查全部的。*/
  getSelectMajorList:function (data) {
    /*{orgId}院系可选*/
    this.axiosGet('/select-data/major-info/all',data)
  },
  ...
  getSelectTeacherList:function (data) {
    ...
    this.axiosGet('/select-data/instructor-info/all',data)
  },
  /*每周数据页面*/
    ...
    getWeekExeceptionTotal:function (data) {
      /*{orgId}可选*/
      /*{weekNumber}必填*/
      this.axiosGet('/analysis/exeception-stat-by-week',data)
    },
    /*2、晚归考勤分析模块接口-每周异常数据列表统计 GET /analysis/exeception-stat-by-day-of-week  趋势图用*/
  getWeekExeceptionChart:function (data) {
    /*{orgId}可选*/
    /*{weekNumber}必填*/
    this.axiosGet('/analysis/exeception-stat-by-day-of-week',data)
  },
  ...
  getWeekExeceptionPagenation:function (data) {
    ...
    /*{weekNum}必填*/
    this.axiosGet('/analysis/exeception-clock-by-week',data)
  },
  /*学生关怀页面*/
    ...
    getCareStudentList:function (data) {
      ...
      this.axiosGet('/analysis/care/can-start',data)
    },
  ...
  putDeleteStudentCare:function (operatorId,studentIds) {
    this.axiosPut('/analysis/delete-student-care',{
      operatorId:operatorId,
      studentIds:studentIds
    })
  },
 /*学生考勤查询*/
    ...
    getRecheckPagenationData:function (data) {
      ...
      this.axiosGet('/data-recheck/student-clock-care-stat',data)
    },
  /*辅导员查寝签到*/
